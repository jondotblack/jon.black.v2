    ...
    <Layout bgColor="swissCoffee" seo={{ title: 'Office hours' }}>
      <Banner>
        <Heading>
          ...
          paying it forward. Office hours are free and open to anyone to schedule. If you need help
          fleshing out ideas, working through a problem, having trouble with an employee, book a
          time below.
        </Heading>
      </Banner>
